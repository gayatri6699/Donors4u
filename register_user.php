...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8  w3-light-grey w3-border w3-padding-16 ">
		  <center><div class="w3" style="color:red"><h2>Reciever/User Register</h2></div></center>
		 ...
		 <center> <a href="#" class="btn btn-outline-danger" id="register">Register</a></center>
		</div>
		<div class="col-md-2"></div>
	</div>
</div>
