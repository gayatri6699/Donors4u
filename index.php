...
<div class="container-fluid bb">
	<!-- <div class="card"> -->
	<div class="container bb title">
    <div class="row">
        
	    <div class="col-md-12"><pre>
	    </pre>
	        <h1 class="text-center" style="color:white"><b>Blood Bank</b></h1><br/><pre>



	        <h2 class="text-center"  style="color:white"><b>A life may depend on a gesture from you, a bottle of Blood</b></h2>
	    </pre>
	    </div>
    </div>
	</div>
		<div class="row w3-padding-24">
			<div class="col-md-4">
				<div class="form-group">
				    <center><label for="volume">Volume</label></center>
			...
			<div class="col-md-4">
				<div class="form-group">
				    <center><label for="blood">Blood Group</label></center>
	...
	<center><h2 class="heading" style="color:red">Available Blood Samples</h2></center> 
	<center><div class="row container-fluid">
	    
<!--
	    <div class="col-md-3" style="margin-top:18px;">
	        <img src="images/bb.png" height="320px" width="320px" alt="">
	    </div>
-->
...
<!--<div class="parallax-window list" data-parallax="scroll" data-image-src="images/banner4.png">  -->
