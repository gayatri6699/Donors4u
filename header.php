...
<body>
  	<nav class="navbar navbar-toggleable-md navbar-default fixed-top bg">
	  <button class="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
	    <span class="navbar-toggler-icon"></span>
	  </button>
	  <a class="navbar-brand" href="index.php"><?=$COMPANY_NAME?></a>
	  <div class="collapse navbar-collapse justify-content-end links" id="navbarNavDropdown">
	    <ul class="navbar-nav">
	    	...
	    	<?php
	    		...
	    		if(isset($_SESSION["type"]) && $_SESSION["type"]=="hospital" && isset($_SESSION["id"]) && !empty($_SESSION["id"])){
	    			...
	    			$out.='<li class="nav-item" id="tab_login">';
						$out.='<a class="nav-link" href="cl.php">Login</a>';
					$out.='</li>';
